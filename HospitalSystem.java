// ============================================================================
// HospitalSystem.java - Core hospital management logic
// ============================================================================
// BUGS IN THIS FILE:
...
public class HospitalSystem {
    ...
    public void updatePatientAge(int patientId, int newAge)
        ...
        try {
            if (newAge < 0) {
                throw new IllegalArgumentException("Age cannot be negative: " + newAge);
            }
            if (newAge > 150) {
                throw new IllegalArgumentException("Age unrealistic: " + newAge);
            }
    ...
    public void scheduleAppointment(int patientId, String dateTime,
        ...
        for (String appt : patientAppointments) {
            if (appt.startsWith(dateTime)) {
                // Conflict detected
                throw new AppointmentConflictException(
                        patient.getName(), dateTime, appt);
            }
        }
